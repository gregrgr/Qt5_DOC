...
#include "../HelloWorld/subwidget.h"
...
QT_MOC_LITERAL(1, 10, 12), // "changeWindow"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "SubWidget\0changeWindow\0"
};
...
void SubWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SubWidget::changeWindow)) {
                *result = 0;
                return;
            }
        }
